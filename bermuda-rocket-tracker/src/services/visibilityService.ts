...
// import { isNightTime as isNightTimeProper, getVisibilityConditions, getLightingDescription } from '../utils/astronomicalCalculations';
...
function isNightTime(launchTime: string, bermudaTime: string): boolean {
  // Improved night time detection - 8:00 PM onwards is night
